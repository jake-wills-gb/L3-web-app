<a>
	<?php
		if(isset($candidature)){
			//echo '<a href="'.base_url().'/Candidature/supprimer/?id='.$candidature[0]['CDR_candidature_id'].'">Supprimer candidature</a>';
			...
			echo '<td><a type="sumbit" href="'.base_url().'index.php/Candidature/supprimer/?id='.$candidature[0]['CDR_candidature_id'].'">Supprimer</a></td>';
			echo '</tr>';
			echo '</tbody>';
			echo '</table>';
			echo '<table class="table">';
